...
@constants GNU_PROPERTY "" begin
    const GNU_PROPERTY_STACK_SIZE = UInt32(1)
    const GNU_PROPERTY_NO_COPY_ON_PROTECTED	= UInt32(2)
    const GNU_PROPERTY_LOPROC = 0xc0000000
    const GNU_PROPERTY_HIPROC = 0xdfffffff
    const GNU_PROPERTY_LOUSER = 0xe0000000
    const GNU_PROPERTY_HIUSER = 0xffffffff
    const GNU_PROPERTY_X86_ISA_1_USED = 0xc0010002
    const GNU_PROPERTY_X86_ISA_1_NEEDED = 0xc0008002
    const GNU_PROPERTY_X86_FEATURE_1_AND = 0xc0000002
end

@constants GNU_PROPERTY_X86_ISA_1 "GNU_PROPERTY_X86_ISA_1_" begin
    const GNU_PROPERTY_X86_ISA_1_BASELINE = UInt32(1)
    const GNU_PROPERTY_X86_ISA_1_V2 = UInt32(2)
    const GNU_PROPERTY_X86_ISA_1_V3 = UInt32(4)
    const GNU_PROPERTY_X86_ISA_1_V4	= UInt32(8)
end

const GNU_PROPERTY_X86_ISA_1_to_str = Dict(GNU_PROPERTY_X86_ISA_1_BASELINE=>"CMOV, CX8 (cmpxchg8b), FPU (fld), MMX, OSFXSR (fxsave), SCE (syscall), SSE, SSE2", GNU_PROPERTY_X86_ISA_1_V2 => "CMPXCHG16B (cmpxchg16b), LAHF-SAHF (lahf), POPCNT (popcnt), SSE3, SSSE3, SSE4.1, SSE4.2", GNU_PROPERTY_X86_ISA_1_V3 => "AVX, AVX2, BMI1, BMI2, F16C, FMA, LZCNT, MOVBE, XSAVE", GNU_PROPERTY_X86_ISA_1_V4 => "AVX512F, AVX512BW, AVX512CD, AVX512DQ and AVX512VL")

@constants GNU_PROPERTY_X86_FEATURE_1 "GNU_PROPERTY_X86_FEATURE_1_" begin
